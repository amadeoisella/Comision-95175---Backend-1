...
console.log(
  "📄 Leí el package.json. Primeros 80 chars:",
...
const datos = JSON.stringify(
  { usuario: "Ana", rol: "admin", creado: new Date() },
  null,
  2,
);
...
fs.readFile("log_usuario.json", "utf8", (err, data) => {
  ...
  console.log(
    "🔍 Usuario leído de forma asíncrona:",
    usuario.usuario,
    "— rol:",
    usuario.rol,
  );
...
console.log(
  "⚡ Esta línea se imprime ANTES de que fs termine de leer. (¡Asincronismo!)",
);
